# 4 - No Auto Recall
scoreboard players set #preset trident.config 4
##### ##### ##### ##### ##### ##### ##### ##### 

scoreboard players set #trident_lock trident.config 60
scoreboard players set #auto_recall trident.config 1
scoreboard players set #instant_recall trident.config 1
